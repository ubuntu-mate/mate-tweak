...
data_files = [
    ...
    ('{prefix}/lib/mate-tweak'.format(prefix=sys.prefix), ['data/mate-tweak.ui', 'util/disable-mate-volume-applet', 'util/mate-panel-backup', 'util/mate-tweak-helper']),
]
...
setup(
    ...
    scripts = ['mate-tweak', 'marco-compton', 'marco-xcompmgr', 'marco-no-composite', 'metacity-compton', 'metacity-xcompmgr', 'metacity-no-composite'],
    cmdclass = cmdclass,
)
